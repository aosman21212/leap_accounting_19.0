...
class AccountJournal(models.Model):
    ...
    def _l10n_sa_get_production_CSID(self, OTP=None):
        ...
        renew = False
        zatca_format = self.env.ref('leap_l10n_sa_edi.edi_sa_zatca')
    ...
    def _l10n_sa_get_compliance_files(self):
        ...
        for file in file_names:
            fpath = f'leap_l10n_sa_edi/tests/compliance/{file}'
    ...
    def _l10n_sa_run_compliance_checks(self):
        ...
        for fname, fval in compliance_files.items():
            invoice_hash_hex = self.env['account.edi.xml.ubl_21.zatca']._l10n_sa_generate_invoice_xml_hash(
                fval).decode()
            digital_signature = self.env.ref('leap_l10n_sa_edi.edi_sa_zatca')._l10n_sa_get_digital_signature(self.company_id, invoice_hash_hex).decode()
    ...
    def _l10n_sa_prepare_compliance_xml(self, xml_name, xml_raw, certificate, signature):
        ...
        signed_xml = self.env.ref('leap_l10n_sa_edi.edi_sa_zatca')._l10n_sa_sign_xml(xml_content, certificate, signature)
    ...
    def _l10n_sa_prepare_invoice_xml(self, xml_content):
        ...
        """
        ubl_extensions = etree.fromstring(self.env['ir.qweb']._render('leap_l10n_sa_edi.export_sa_zatca_ubl_extensions'))
    ...
    def _l10n_sa_edi_create_new_chain(self):
        ...
        return self.env['ir.sequence'].create({
            ...
            'code': f'leap_l10n_sa_edi.account.move.{self.id}',
