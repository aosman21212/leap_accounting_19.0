...
class TestBankReconcile(AccountKitCommon):
    ...
    def test_auto_reconcile_cron_inactive(self):
        ...
        cron = self.env.ref('leap_accounting_kit.ir_cron_bank_auto_reconcile')
    ...
    def test_action_open_reconcile_targets_widget_views(self):
        ...
        self.env.ref(
            'leap_accounting_kit.account_bank_statement_line_view_kanban')
        self.env.ref(
            'leap_accounting_kit.view_bank_reconcile_widget_form')
