...
class AccountMove(models.Model):
        ...
        for move in self:
            ...
            if move.country_code == 'SA' and move.move_type in ('out_invoice', 'out_refund') and zatca_document and move.state != 'draft':
                ...
                if move._l10n_sa_is_simplified():
                    ...
                    xml_content = self.env.ref('leap_l10n_sa_edi.edi_sa_zatca')._l10n_sa_generate_zatca_template(move)
    ...
    def _l10n_sa_generate_unsigned_data(self):
        ...
        """
        self.ensure_one()
        edi_format = self.env.ref('leap_l10n_sa_edi.edi_sa_zatca')
    ...
    def _retry_edi_documents_error(self):
        ...
        zatca = self.env.ref('leap_l10n_sa_edi.edi_sa_zatca')
