...
from odoo.addons.leap_l10n_sa_edi.tests.common import TestSaEdiCommon
...
class TestEdiZatca(TestSaEdiCommon):
    ...
    def testCreditNoteSimplified(self):
        ...
        self._test_document_generation(
            ...
            test_file_path='leap_l10n_sa_edi/tests/compliance/simplified/credit.xml',
    ...
    def testCreditNoteStandard(self):
        ...
        self._test_document_generation(
            document_type='credit_note',
            test_file_path='leap_l10n_sa_edi/tests/compliance/standard/credit.xml',
            expected_xpath=self.credit_note_applied_xpath,
            move_data=move_data,
    ...
    def testDebitNoteSimplified(self):
        ...
        self._test_document_generation(
            ...
            test_file_path='leap_l10n_sa_edi/tests/compliance/simplified/debit.xml',
    ...
    def testDebitNoteStandard(self):
        ...
        self._test_document_generation(
            document_type='debit_note',
            test_file_path='leap_l10n_sa_edi/tests/compliance/standard/debit.xml',
            expected_xpath=self.debit_note_applied_xpath,
            move_data=move_data,
    ...
    def testInvoiceSimplified(self):
        ...
        self._test_document_generation(
            ...
            test_file_path='leap_l10n_sa_edi/tests/compliance/simplified/invoice.xml',
    ...
    def testInvoiceStandard(self):
        ...
        self._test_document_generation(
            document_type='invoice',
            test_file_path='leap_l10n_sa_edi/tests/compliance/standard/invoice.xml',
            expected_xpath=self.invoice_applied_xpath,
            move_data=move_data,
    ...
    def testInvoiceWithDownpayment(self):
        ...
        for move, test_file in [
            ...
            with self.subTest(move=move, test_file=test_file):
                self._test_document_generation(
                    test_file_path=f'leap_l10n_sa_edi/tests/test_files/{test_file}.xml',
                    expected_xpath=self.invoice_applied_xpath,
                    additional_xpath=additional_xpath,
    ...
    def test_otp_validation_without_company_street(self):
        ...
        wizard = self.env['leap_l10n_sa_edi.otp.wizard'].create({
