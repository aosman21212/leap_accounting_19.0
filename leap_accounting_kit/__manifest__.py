...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'leap_accounting_kit/static/src/scss/style.scss',
            'leap_accounting_kit/static/src/scss/bank_rec_widget.css',
            'leap_accounting_kit/static/src/js/bank_reconcile_form_list_widget.js',
            'leap_accounting_kit/static/src/js/KanbanController.js',
            'leap_accounting_kit/static/src/js/ListController.js',
            'leap_accounting_kit/static/src/js/bank_reconcile_form_lines_widget.js',
            'leap_accounting_kit/static/src/js/action_manager.js',
            'leap_accounting_kit/static/src/xml/bank_rec_widget.xml',
            'leap_accounting_kit/static/src/xml/bank_reconcile_widget.xml',
        ]
    },
    'license': 'LGPL-3',
