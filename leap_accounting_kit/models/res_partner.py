...
class ResPartner(models.Model):
    ...
    def _followup_letter_report(self):
        return self.env.ref(
            'leap_accounting_kit.action_report_followup_letter',
    ...
    def _send_followup(self, followup_line=None):
        ...
        default_template = self.env.ref(
            'leap_accounting_kit.mail_template_followup',
            raise_if_not_found=False)
        for partner in self:
    ...
    def action_share_pdf(self):
        ...
        if self.customer_report_ids:
            ...
            report = self.env['ir.actions.report'].sudo()._render_qweb_pdf(
                'leap_accounting_kit.res_partner_action', self, data=data)
    ...
    def action_print_pdf(self):
        ...
        if self.customer_report_ids:
            ...
            return self.env.ref('leap_accounting_kit.res_partner_action'
    ...
    def action_vendor_print_pdf(self):
        ...
        return self.env.ref(
            'leap_accounting_kit.res_partner_action').report_action(
            self, data=data)
